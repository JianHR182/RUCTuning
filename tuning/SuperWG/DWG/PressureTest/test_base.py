...
import time
import re
from SuperWG.DWG.PressureTest.schema_alter import *
import json
    ...
    try:
        ...
        with open(log_path, 'w') as f:
            ...
            for i,it in enumerate(sql_list):
                ...
                connection.commit()
                if i%500==0:
                    f.write(f"{i} sqls has been processed successfully.\n")
