...
if __name__=="__main__":
    ...
    parser.add_argument('--hostname', type=str, default='182.92.85.148')
    parser.add_argument('--username', type=str, default='lzz')
    parser.add_argument('--omm_password', type=str, default='opgs1234321#')
    parser.add_argument('--user_password', type=str, default='zongze123@')
    parser.add_argument('--sql_path', type=str, default='/home/lzz/schema/test.sql')
    ...
    parser.add_argument('--cache_path', type=str, default='/home/lzz/SuperWG/DWG/jsonHelper/data/test.sql')
    parser.add_argument('--result_path', type=str, default='/home/lzz/SuperWG/DWG/jsonHelper/data/res.json')
